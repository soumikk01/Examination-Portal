...
export const api = {
    getStudents: () =>
        safeFetch(`${API_BASE_URL}/students`),

    searchStudents: (query) =>
        safeFetch(`${API_BASE_URL}/search?query=${encodeURIComponent(query)}`),
    ...
    deleteExam: (collegeId, examId) =>
        safeFetch(`${API_BASE_URL}/student/${encodeURIComponent(collegeId)}/exam/${encodeURIComponent(examId)}`, {
            method: 'DELETE'
        })
};
