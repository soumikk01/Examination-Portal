  ...
  return (
    <PageLayout>
      <div style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: '1152px' }}>
        ...
        <Card className="mb-8" style={{ backgroundColor: '#f0f4f8' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-base">
            ...
            <div className="flex gap-2 items-center">
              ...
              <span className="text-gray-900 font-semibold">
                {[student.degree, student.department, student.batch].filter(Boolean).join(' - ') ||
                  'N/A'}
              </span>
            </div>
          </div>
        ...
        >
          <div className="bg-[#fffdf0] border border-[#e6e2c8] p-6 rounded-sm shadow-[2px_4px_8px_rgba(0,0,0,0.1)]">
            <div className="text-center">
              <h4 className="font-bold text-gray-800 text-lg mb-2">
                <span className="mr-1">📌</span>Important Notice
              </h4>

              <p className="text-gray-700 leading-relaxed">
                Please report to your assigned room
                <span className="text-red-600 font-bold"> at least 15 minutes</span>
                before the scheduled examination time. Students must wear the
