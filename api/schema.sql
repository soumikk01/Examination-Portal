...
((SELECT id FROM Students WHERE collegeId = 'CS2024001'), 'EX001', 'Data Structures', 85, '2024-05-15', '10:00 AM', 'Block A - 101', 'Regular', 'ODD'),
((SELECT id FROM Students WHERE collegeId = 'CS2024001'), 'EX002', 'Algorithms', 90, '2024-05-17', '02:00 PM', 'Block B - 205', 'Backlog', 'EVEN'),
((SELECT id FROM Students WHERE collegeId = 'CS2024002'), 'EX001', 'Data Structures', 78, '2024-05-15', '10:00 AM', 'Block A - 102', 'Regular', 'ODD'),
((SELECT id FROM Students WHERE collegeId = 'ME2024003'), 'EX003', 'Thermodynamics', 88, '2024-05-20', '09:00 AM', 'Block C - 301', 'Regular', 'EVEN'),
-- Soumik Biswas Exams
((SELECT id FROM Students WHERE collegeId = 'jis/2000/000'), 'EX101', 'Mathematics Examination', NULL, '2026-01-1', '09:00 AM', 'Hall A - Room 101', 'Regular', 'ODD'),
